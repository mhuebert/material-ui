  ...
  render: function() {
    ...
    var inputElement = this.props.multiline ?
      this.props.valueLink ?
        React.DOM.textarea(Object.assign({}, this.props, {ref: "input", 
        ...
        this.props.valueLink ?
          React.DOM.input(Object.assign({}, this.props, {ref: "input", 
    ...
    var placeholderSpan = this.props.inlinePlaceholder ? null : 
      React.DOM.span({className: "mui-input-placeholder", onClick: this._onPlaceholderClick}, 
